...
public partial class MainPage : ContentPage
{
    ...
    {
        InitializeComponent();
        // mParticle is initialized at app startup (App.xaml.cs) - disable manual init
        InitializeBtn.Text = "Initialized at startup";
    ...
    private void OnInitializeClicked(object sender, EventArgs e)
    {
        ...
        var options = new MParticleOptions()
        {
            ...
            Environment = mParticle.MAUI.Environment.Development,
            ApiKey = key,
            ApiSecret = secret,
        ...
        SemanticScreenReader.Announce("mParticle SDK has been initialized successfully");
    }

    private void OnBasicEventsClicked(object sender, EventArgs e)
    {
        var mparticle = MParticle.Instance;

        Console.WriteLine($"Environment: {mparticle.Environment}");
        ...
        BasicEventsBtn.Text = "Basic Events Logged!";
        SemanticScreenReader.Announce("Basic mParticle events have been logged successfully");
    }

    private void OnCommerceEventsClicked(object sender, EventArgs e)
    {
        var mparticle = MParticle.Instance;
        ...
        CommerceEventsBtn.Text = "Commerce Events Logged!";
        SemanticScreenReader.Announce("Commerce events have been logged successfully");
    }

    private void OnScreenEventsClicked(object sender, EventArgs e)
    {
        var mparticle = MParticle.Instance;
        ...
        ScreenEventsBtn.Text = "Screen Events Logged!";
        SemanticScreenReader.Announce("Screen events and breadcrumbs have been logged successfully");
    }

    private void OnUploadBypassClicked(object sender, EventArgs e)
    {
        var mparticle = MParticle.Instance;
        ...
        UploadBypassBtn.Text = "Upload Bypass Tested!";
        SemanticScreenReader.Announce("Upload bypass functionality has been tested successfully");
    }

    private void OnATTStatusClicked(object sender, EventArgs e)
    {
        var mparticle = MParticle.Instance;

        mparticle.SetATTStatus(MPATTAuthorizationStatus.Authorized, null);

        ATTStatusBtn.Text = "ATT Status Set!";
        SemanticScreenReader.Announce("App Tracking Transparency status has been set successfully");
    }

    private void OnExecuteClicked(object sender, EventArgs e)
    {
        // Run all test functions
        OnBasicEventsClicked(sender, e);
        OnCommerceEventsClicked(sender, e);
        OnScreenEventsClicked(sender, e);
        OnUploadBypassClicked(sender, e);
        OnATTStatusClicked(sender, e);

        ExecuteBtn.Text = "All Tests Completed!";
        SemanticScreenReader.Announce("All mParticle test functions have been executed successfully");
    }
    ...
    private void OnShowRoktEmbeddedClicked(object sender, EventArgs e)
    {
    ...
    private void OnShowRoktOverlayClicked(object sender, EventArgs e)
    {
