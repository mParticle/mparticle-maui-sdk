...
namespace mParticle.MAUI.Rokt.Android;

/// <summary>
/// Android implementation of the cross-platform <see cref="RoktApi"/>. It bridges to the
/// mParticle Android Rokt kit through the <c>com.mparticle.mparticleroktbinding</c> helper,
/// keeping the Kotlin Flow / roktsdk types out of the managed binding surface.
/// </summary>
internal sealed class AndroidRoktApiWrapper : RoktApi
{
    // Hold event subscriptions/listeners so they are not garbage collected while active.
    private static readonly List<object> EventSubscriptions = new();
